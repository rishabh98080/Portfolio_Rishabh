  ...
  return (
    <SectionWrapper id="hero" className={cn("relative w-full h-screen")}>
      <div className="grid md:grid-cols-2">
        ...
        <div className="hidden md:flex col-span-1 items-center justify-center pt-24 pr-12">
          <img 
            src="/assets/me.jpg" 
            alt="My Photo" 
            className="w-full max-w-[400px] aspect-square rounded-full object-cover border-4 border-primary/20 drop-shadow-[0_0_30px_rgba(var(--primary),0.2)] animate-fade-left"
          />
        </div>
      </div>
